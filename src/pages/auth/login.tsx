    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <div className="container mx-auto py-8 shadow-lg">
                ...
                <div
                    className="bg-gray-50 flex  glass min-h-screen p-10">
                    ...
                    <form method="post" action="/api/auth/signin/email" className="max-h-96 shadow-md  align-middle candy-mesh  bg-white p-2 m-2 flex min-h-96 min-w-96 flex-grow flex-col rounded-xl">
                    ...
                    <form method="post" action="/api/auth/signin/google" className="max-h-96 shadow-md rainbow-mesh align-middle bg-white p-2 m-2 flex min-h-96 min-w-96 flex-grow flex-col rounded-xl">
